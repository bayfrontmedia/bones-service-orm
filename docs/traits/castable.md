...
This is particularly useful within the [getMutatorFields](../models/resourcemodel.md#getmutatorfields) 
and [getAccessorFields](../models/resourcemodel.md#getaccessorfields) `ResourceModel` methods.
...
class Users extends ResourceModel
{
	 ...
	 * Mutator array as: field => callable
	 *
	 * @return array
	 */
	 ...
	 * Accessor array as: field => callable
	 *
	 * @return array
	 */
